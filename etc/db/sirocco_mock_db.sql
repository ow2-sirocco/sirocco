...
INSERT INTO `CLOUDPROVIDER` VALUES (3,'mock','a mock cloud provider','dummy');
...
INSERT INTO `CLOUDPROVIDERACCOUNT` VALUES (4,'dummy','dummy',3);
...
INSERT INTO `CLOUDPROVIDERACCOUNT_TENANT` VALUES (4,1);
...
INSERT INTO `CLOUDPROVIDERLOCATION` VALUES (5,NULL,NULL,NULL,NULL,'France','FR','FR-75',NULL,'Paris');
...
INSERT INTO `CLOUDPROVIDERLOCATION_CLOUDPROVIDER` VALUES (3,5);
...
INSERT INTO `CLOUDRESOURCE` VALUES (6,'MachineImage','2013-09-30 09:46:53',NULL,'Ubuntu 12.04 64 bits','ubuntu-12.04-amd64-server',NULL,NULL,1),(15,'Network',NULL,NULL,NULL,'public network',NULL,NULL,1);
...
INSERT INTO `JOB` VALUES (7,'add','2013-09-30 09:46:53',NULL,'MachineImage creation',NULL,NULL,NULL,NULL,0,'SUCCESS',NULL,NULL,NULL,NULL,NULL,6,1),(16,'add','2013-09-30 09:47:10',NULL,NULL,NULL,NULL,NULL,NULL,NULL,'SUCCESS',NULL,'2013-09-30 09:47:10',NULL,NULL,NULL,15,NULL);
...
INSERT INTO `JOB_CLOUDRESOURCE` VALUES (7,6),(16,15);
...
--
-- Table structure for table `LOCKITEM`
--

DROP TABLE IF EXISTS `LOCKITEM`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `LOCKITEM` (
  `ID` int(11) NOT NULL,
  `LOCKEDOBJECTID` varchar(255) DEFAULT NULL,
  `LOCKEDOBJECTTYPE` varchar(255) DEFAULT NULL,
  `LOCKEDTIME` datetime DEFAULT NULL,
  `OPTLOCK` bigint(20) DEFAULT NULL,
  PRIMARY KEY (`ID`),
  UNIQUE KEY `UNQ_LOCKITEM_0` (`LOCKEDOBJECTID`,`LOCKEDOBJECTTYPE`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `LOCKITEM`
--

LOCK TABLES `LOCKITEM` WRITE;
/*!40000 ALTER TABLE `LOCKITEM` DISABLE KEYS */;
/*!40000 ALTER TABLE `LOCKITEM` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `MACHINECONFIGURATION` VALUES (8,1,'2013-09-30 09:46:55',NULL,'Amazon micro instance type',645120,'micro',NULL,NULL,'PUBLIC',1),(9,1,'2013-09-30 09:46:57',NULL,'Nova tiny instance type',524288,'tiny',NULL,NULL,'PUBLIC',1),(10,1,'2013-09-30 09:46:59',NULL,'Nova small instance type',2097152,'small',NULL,NULL,'PUBLIC',1),(11,2,'2013-09-30 09:47:02',NULL,'Nova medium instance type',4194304,'medium',NULL,NULL,'PUBLIC',1),(12,4,'2013-09-30 09:47:04',NULL,'Nova large instance type',8388608,'large',NULL,NULL,'PUBLIC',1),(13,8,'2013-09-30 09:47:06',NULL,'Nova xlarge instance type',16777216,'xlarge',NULL,NULL,'PUBLIC',1);
...
INSERT INTO `MACHINEIMAGE` VALUES (6,'','AVAILABLE','IMAGE','PUBLIC',NULL,NULL,NULL);
...
INSERT INTO `MachineConfiguration_DISKS` VALUES (0,'','',8),(0,'','',9),(20000000,'','',10),(40000000,'','',11),(80000000,'','',12),(160000000,'','',13);
...
INSERT INTO `NETWORK` VALUES (15,NULL,NULL,'PUBLIC','STARTED',NULL,NULL,NULL);
...
INSERT INTO `NETWORKCONFIGURATION` VALUES (14,NULL,'2013-09-30 09:47:08',NULL,'Public Network Config',NULL,'publicNetworkConfig','PUBLIC',NULL,NULL,'PRIVATE',1);
...
-- Dump completed on 2013-09-30  9:48:57
