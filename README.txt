...
2) Configure Glassfish for Sirocco
...
3) Create and initialize Sirocco MySQL database
...
4) Start GlassFish and deploy Sirocco
...
5) Install Sirocco and CIMI command-line tools
...
6) Testing your minimal installation
...
* Connect to Sirocco Web Portal at http://localhost:8080/dashboard/ui
